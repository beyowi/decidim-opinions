...
describe "Opinions", type: :system do
  ...
  context "when creating a new opinion" do
    let(:scope_picker) { select_data_picker(:opinion_scope_id) }
    ...
    context "when the user is logged in" do
      ...
      context "with creation enabled" do
        ...
        let(:opinion_draft) { create(:opinion, :draft, component: component) }

        context "when process is not related to any scope" do
          it "can be related to a scope" do
            visit complete_opinion_path(component, opinion_draft)
        ...
        context "when geocoding is enabled", :serves_map do
          ...
          let(:opinion_draft) { create(:opinion, :draft, users: [user], component: component, title: "More sidewalks and less roads", body: "He will not solve everything") }

          it "creates a new opinion", :slow do
            visit complete_opinion_path(component, opinion_draft)

            within ".edit_opinion" do
              check :opinion_has_address
              fill_in :opinion_title, with: "More sidewalks and less roads"
              fill_in :opinion_body, with: "Cities need more people, not more cars"
        ...
        context "when component has extra hashtags defined" do
          ...
          it "offers and save extra hashtags", :slow do
            ...
            within ".edit_opinion" do
              check :opinion_suggested_hashtags_suggestedhashtag1
        ...
        context "when the user has verified organizations" do
          ...
          let(:user_group_opinion_draft) { create(:opinion, :draft, users: [user], component: component, title: "More sidewalks and less roads", body: "Cities need more people, not more cars") }

          before do
            create(:user_group_membership, user: user, user_group: user_group)
          end

          it "creates a new opinion as a user group", :slow do
            visit complete_opinion_path(component, user_group_opinion_draft)
            ...
            within ".edit_opinion" do
              ...
              select translated(category.name), from: :opinion_category_id
              scope_pick scope_picker, scope
              select user_group.name, from: :opinion_user_group_id
        ...
        context "when attachments are allowed", processing_uploads_for: Decidim::AttachmentUploader do
          ...
          let(:opinion_draft) { create(:opinion, :draft, users: [user], component: component, title: "Opinion with attachments", body: "This is my opinion and I want to upload attachments.") }
          ...
          it "creates a new opinion with attachments" do
            ...
            within ".edit_opinion" do
              ...
              fill_in :opinion_body, with: "This is my opinion and I want to upload attachments."
      ...
      context "when creation is not enabled" do
        it "does not show the creation button" do
          visit_component
          expect(page).to have_no_link("New opinion")
        end
      end

      context "when the opinion limit is 1" do
        let!(:component) do
          create(:opinion_component,
                 :with_creation_enabled,
                 :with_opinion_limit,
        ...
        let!(:opinion_first) { create(:opinion, users: [user], component: component, title: "Creating my first and only opinion", body: "This is my only opinion's body and I'm using it unwisely.") }
        ...
        it "allows the creation of a single new opinion" do
          within ".new_opinion" do
            fill_in :opinion_title, with: "Creating my second opinion"
            fill_in :opinion_body, with: "This is my second opinion's body and I'm using it unwisely."
...
def complete_opinion_path(component, opinion)
  Decidim::EngineRouter.main_proxy(component).opinion_path(opinion) + "/complete"
end
