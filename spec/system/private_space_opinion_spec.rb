...
describe "Private Space Opinion", type: :system do
  ...
  context "when space is private and transparent" do
    ...
    context "when the user is not logged in" do
      it "does not allow create a opinion" do
        visit_component
    ...
    context "when the user is logged in" do
      context "and is private user space" do
        ...
        it "not allows create a opinion" do
          visit_component

          expect(page).to have_link("New opinion")
        end
      end
  ...
  context "when the spaces is private and not transparent" do
    ...
    context "when the user is logged in" do
      context "and is private user space" do
        ...
        it "allows create a opinion" do
          visit_component

          click_link "New opinion"

          within ".new_opinion" do
            fill_in :opinion_title, with: "Creating my opinion"
            fill_in :opinion_body, with: "This is my opinion's body and I'm using it unwisely."
