...
describe "Amendment Wizard", type: :system do
  ...
  let!(:opinion) { create(:opinion, title: "More roads and less sidewalks", component: component) }
  ...
  context "when amending a opinion" do
    before do
    ...
    context "and in step_1: Create your amendment" do
      ...
      context "when the back button is clicked" do
        ...
        it "redirects to the opinion page" do
          expect(page).to have_content(opinion.title)
          expect(page).to have_content("AMEND OPINION")
        end
      end
    end
    ...
    context "and in step_2: Compare your amendment" do
      context "with similar results" do
        let!(:emendation) { create(:opinion, title: title, body: body, component: component) }
    ...
    context "and in step_4: Publish your amendment" do
      ...
      context "when the Publish button is clicked", versioning: true do
        ...
        it "publishes the amendment" do
          expect(page).to have_css(".callout.warning", text: "This amendment for the opinion #{opinion.title} is being evaluated.")
  ...
  context "with existing amendment drafts" do
    ...
    let!(:amendment) { create :amendment, amendable: opinion, emendation: emendation }
    let!(:emendation_draft) { create(:opinion, :unpublished, component: component) }
    let!(:amendment_draft) { create :amendment, :draft, amendable: opinion, emendation: emendation_draft }

    context "and visiting an amended opinion" do
      before do
        visit opinion_path
      end
