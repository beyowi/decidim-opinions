...
module Decidim
  module Opinions
    describe OpinionWizardCreateStepForm do
      subject { form }
      ...
      context "when the body exceed the permited length" do
        let(:component) { create(:opinion_component, :with_opinion_length, participatory_space: participatory_space, opinion_length: 15) }
