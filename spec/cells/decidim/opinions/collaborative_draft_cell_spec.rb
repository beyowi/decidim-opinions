...
describe Decidim::Opinions::CollaborativeDraftCell, type: :cell do
  controller Decidim::Opinions::CollaborativeDraftsController

  subject { my_cell.call(:show) }

  let(:my_cell) { cell("decidim/opinions/collaborative_draft", collaborative_draft, context: context) }
