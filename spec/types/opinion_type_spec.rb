...
require "decidim/core/test/shared_examples/amendable_opinions_interface_examples"
...
module Decidim
  module Opinions
    describe OpinionType, type: :graphql do
      include_context "with a graphql type"
      let(:component) { create(:opinion_component) }
      let(:model) { create(:opinion, :with_votes, :with_endorsements, :with_amendments, component: component) }
      ...
      include_examples "amendable opinions interface"
      ...
      describe "id" do
        ...
        it "returns the opinion's id" do
      ...
      describe "voteCount" do
        ...
        context "when votes are not hidden" do
          it "returns the amount of votes for this opinion" do
            expect(response["voteCount"]).to eq(model.votes.count)
          end
        end

        context "when votes are hidden" do
          let(:component) { create(:opinion_component, :with_votes_hidden) }
      ...
      describe "body" do
        ...
        it "returns the opinion's body" do
      ...
      describe "state" do
        ...
        it "returns the opinion's state" do
      ...
      context "when is answered" do
        ...
        describe "answer" do
          ...
          it "returns the opinion's answer" do
      ...
      describe "address" do
        ...
        it "returns the address of this opinion" do
      ...
      describe "participatory_text_level" do
        ...
        it "returns the participatory_text_level of this opinion" do
      ...
      describe "position" do
        ...
        it "returns the position of this opinion" do
      ...
      describe "created_in_meeting" do
        ...
        it "returns the created_in_meeting of this opinion" do
      ...
      describe "meeting" do
        ...
        let(:model) { create(:opinion, :official_meeting, component: component) }

        it "returns the meeting of this opinion" do
