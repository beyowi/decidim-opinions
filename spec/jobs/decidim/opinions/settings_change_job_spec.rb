        ...
        context "when creation is enabled" do
          ...
          it "notifies the space followers about it" do
            expect(Decidim::EventsManager)
              .to receive(:publish)
              .with(
                event: "decidim.events.opinions.creation_enabled",
                event_class: Decidim::Opinions::CreationEnabledEvent,
                resource: component,
                followers: [user]
              )
        ...
        context "when voting is enabled and unlocked" do
          ...
          it "notifies the space followers about it" do
            expect(Decidim::EventsManager)
              .to receive(:publish)
              .with(
                event: "decidim.events.opinions.voting_enabled",
                event_class: Decidim::Opinions::VotingEnabledEvent,
                resource: component,
                followers: [user]
              )
        ...
        context "when endorsing is enabled and unlocked" do
          ...
          it "notifies the space followers about it" do
            expect(Decidim::EventsManager)
              .to receive(:publish)
              .with(
                event: "decidim.events.opinions.endorsing_enabled",
                event_class: Decidim::Opinions::EndorsingEnabledEvent,
                resource: component,
                followers: [user]
              )
