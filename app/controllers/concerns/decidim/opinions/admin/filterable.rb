    ...
    module Admin
      module Filterable
        ...
        included do
          ...
          helper Decidim::Opinions::Admin::FilterableHelper
          ...
          def base_query
            ...
            accessible_opinions_collection
          end

          def accessible_opinions_collection
          ...
          # Decidim::Opinions::Admin::FilterableHelper#extra_dropdown_submenu_options_items
          def opinion_states
            Opinion::POSSIBLE_STATES.without("not_answered")
          end
        end
      end
    end
