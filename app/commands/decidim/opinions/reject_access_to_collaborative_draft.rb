    ...
    class RejectAccessToCollaborativeDraft < Rectify::Command
      ...
      def notify_collaborative_draft_authors
        Decidim::EventsManager.publish(
          event: "decidim.events.opinions.collaborative_draft_access_rejected",
          event_class: Decidim::Opinions::CollaborativeDraftAccessRejectedEvent,
      ...
      def notify_collaborative_draft_requester
        Decidim::EventsManager.publish(
          event: "decidim.events.opinions.collaborative_draft_access_requester_rejected",
          event_class: Decidim::Opinions::CollaborativeDraftAccessRequesterRejectedEvent,
          resource: @collaborative_draft,
