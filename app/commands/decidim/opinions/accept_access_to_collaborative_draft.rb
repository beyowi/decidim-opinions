...
module Decidim
  module Opinions
    ...
    class AcceptAccessToCollaborativeDraft < Rectify::Command
      ...
      # collaborative_draft     - A Decidim::Opinions::CollaborativeDraft object.
      ...
      def notify_collaborative_draft_authors
        ...
        Decidim::EventsManager.publish(
          event: "decidim.events.opinions.collaborative_draft_access_accepted",
          event_class: Decidim::Opinions::CollaborativeDraftAccessAcceptedEvent,
      ...
      def notify_collaborative_draft_requester
        Decidim::EventsManager.publish(
          event: "decidim.events.opinions.collaborative_draft_access_requester_accepted",
          event_class: Decidim::Opinions::CollaborativeDraftAccessRequesterAcceptedEvent,
          resource: @collaborative_draft,
