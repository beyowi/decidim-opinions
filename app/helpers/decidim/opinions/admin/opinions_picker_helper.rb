...
module Decidim
  module Opinions
    module Admin
      # This class contains helpers needed to show the Opinions picker.
      #
      module OpinionsPickerHelper
        def opinions_picker(form, field, url)
          picker_options = {
          ...
          prompt_params = {
            url: url,
            text: t("opinions_picker.choose_opinions", scope: "decidim.opinions")
          }
