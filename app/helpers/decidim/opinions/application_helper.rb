  ...
  module Opinions
    ...
    module ApplicationHelper
      ...
      def filter_origin_values
        origin_values = []
        origin_values << TreePoint.new("official", t("decidim.opinions.application_helper.filter_origin_values.official")) if component_settings.official_opinions_enabled
        origin_values << TreePoint.new("citizens", t("decidim.opinions.application_helper.filter_origin_values.citizens"))
        origin_values << TreePoint.new("user_group", t("decidim.opinions.application_helper.filter_origin_values.user_groups")) if current_organization.user_groups_enabled?
        origin_values << TreePoint.new("meeting", t("decidim.opinions.application_helper.filter_origin_values.meetings"))

        TreeNode.new(
          TreePoint.new("", t("decidim.opinions.application_helper.filter_origin_values.all")),
          origin_values
        )
      end
    end
